...
export default class SmartBid20WebPart extends BaseClientSideWebPart<ISmartBid20WebPartProps> {
  private _isDarkTheme: boolean = false;
  private _environmentMessage: string = "";

  public render(): void {
    const element: React.ReactElement<ISmartBid20Props> = React.createElement(
      SmartBid20,
      {
